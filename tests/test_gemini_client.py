...
class TestGeminiClient:
    ...
    def test_init_with_default_model(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_init_with_custom_model(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_initialize_client_failure(self, mock_get_location, mock_get_project_id, mock_genai_client):
        """Test client initialization failure."""
        mock_get_project_id.return_value = "test-project"
        mock_get_location.return_value = "us-central1"
        mock_genai_client.side_effect = Exception("API Error")
        
        with pytest.raises(RuntimeError, match="Failed to initialize Google Gen AI client"):
            GeminiClient()
    
    @patch('src.gemini_client.genai.Client')
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_start_chat(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_send_message_new_session(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_send_message_existing_session(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_send_message_failure(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_get_chat_history_no_session(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_get_chat_history_with_session(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_get_chat_history_exception(self, mock_get_location, mock_get_project_id, mock_genai_client):
    ...
    @patch('src.gemini_client.Config.get_project_id')
    @patch('src.gemini_client.Config.get_location')
    def test_clear_chat(self, mock_get_location, mock_get_project_id, mock_genai_client):
