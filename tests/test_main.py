...
class TestMain:
    ...
    @patch('main.argparse.ArgumentParser.parse_args')
    @patch('main.sys.exit')
    def test_main_keyboard_interrupt(self, mock_exit, mock_parse_args, mock_chatbot_class):
    ...
    @patch('main.argparse.ArgumentParser.parse_args')
    @patch('main.sys.exit')
    def test_main_general_exception(self, mock_exit, mock_parse_args, mock_chatbot_class):
    ...
    @patch('main.argparse.ArgumentParser.parse_args')
    @patch('main.sys.exit')
    def test_main_chatbot_creation_exception(self, mock_exit, mock_parse_args, mock_chatbot_class):
