...
class MockResource:
    ...
    def __init__(self, uri: str, name: str, description: str = "", mimeType: str = "application/octet-stream"):
        self.uri = uri
        self.name = name
        self.description = description
...
class MockPrompt:
    ...
    def __init__(self, name: str, description: str = "", arguments: Optional[List[MockPromptArgument]] = None):
        self.name = name
        self.description = description
...
def create_mock_list_tools_result(tools_data: List[Dict[str, Any]]) -> MockListToolsResult:
...
def create_mock_list_resources_result(resources_data: List[Dict[str, Any]]) -> MockListResourcesResult:
...
def create_mock_list_prompts_result(prompts_data: List[Dict[str, Any]]) -> MockListPromptsResult:
