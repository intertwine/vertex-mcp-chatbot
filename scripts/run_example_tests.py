...
def main():
    ...
    parser.add_argument(
        "--filesystem", action="store_true", help="Run only filesystem server tests"
    )

    parser.add_argument(
        "--weather", action="store_true", help="Run only weather server tests"
    )

    parser.add_argument(
        "--pytest-args", type=str, help="Additional pytest arguments (in quotes)"
    )
    ...
    if args.filesystem and not args.weather:
        ...
        # Run both by default
        test_files = ["tests/test_filesystem_server.py", "tests/test_weather_server.py"]
...
def check_dependencies():
    ...
    filesystem_server = (
        project_root / "examples" / "mcp-servers" / "filesystem_server.py"
    )
